...
if "%2" == "open" start https://test.pypi.org/project/pyweb
echo.
echo [All Done]
exit /b 0
...
if "%2" == "open" start pywebv.github.io
if "%1" == "docs" exit /b 0
echo.
echo [All Done]
exit /b 0
...
echo [Upload to PyPI]
twine upload dist/*
if "%2" == "open" start https://pypi.org/project/pyweb
echo.
echo [All Done]
exit /b 0
