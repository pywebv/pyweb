...
from pyweb.config import ENV
from pyweb.plugins.helpers import db
from pyrogram.errors import PeerIdInvalid


@Web.cmd("botban", owner_only=True)
async def ban_users(bot: Web, msg):
...
@Web.cmd("botunban", owner_only=True)
...
@Web.cmd("botbanlist", owner_only=True)
async def ban_list(bot: Web, msg):
    number = 0
