...
import sys
import argparse
from pyweb.constants import __description__, __version__
...
def main():
    ...
    if args.boilerplate_heroku or args.boilerplate or args.special:
        if args.special:
            print('Generating Boilerplate (for PyWebV)...')
...
def boilerplate(special=False):
    ...
    if special:
        os.system('ghclone https://github.com/pywebv/pyweb/tree/master/boilerplate_pyweb')
    else:
        os.system('ghclone https://github.com/pywebv/pyweb/tree/master/boilerplate')
